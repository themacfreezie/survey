...
### COHO
# dividing into halfs and thirds requires sixths
cutoffs <- quantile(nosa_coho$lnnosa, probs = c(1/6, 1/3, 1/2, 2/3, 5/6), na.rm = TRUE)
                          ...
                          ifelse(nosa_coho$lnnosa <= cutoffs[2], "Q2",
                                 ifelse(nosa_coho$lnnosa <= cutoffs[3], "Q3",
                                        ifelse(nosa_coho$lnnosa <= cutoffs[4], "Q4",
                                               ifelse(nosa_coho$lnnosa <= cutoffs[5], "Q5", "Q6"
                                               )))))
...
nosa_coho_rows$method2 <- ifelse(nosa_coho_rows$nth %in% c("Q1", "Q2", "Q3"), "S", "L")
nosa_coho_rows$method2 <- paste0(nosa_coho_rows$methodNo, "",nosa_coho_rows$method2)

nosa_coho_rows$method3 <- ifelse(nosa_coho_rows$nth %in% c("Q1", "Q2"), "S", 
                                 ifelse(nosa_coho_rows$nth %in% c("Q3", "Q4"), "M", "L"
                                 ))
...
### STEL
# dividing into halfs and thirds requires sixths
cutoffs <- quantile(nosa_stel$lnnosa, probs = c(1/6, 1/3, 1/2, 2/3, 5/6), na.rm = TRUE)
                          ...
                          ifelse(nosa_stel$lnnosa <= cutoffs[2], "Q2",
                                 ifelse(nosa_stel$lnnosa <= cutoffs[3], "Q3",
                                        ifelse(nosa_stel$lnnosa <= cutoffs[4], "Q4",
                                               ifelse(nosa_stel$lnnosa <= cutoffs[5], "Q5", "Q6"
                                               )))))
...
nosa_stel_rows$method2 <- ifelse(nosa_stel_rows$nth %in% c("Q1", "Q2", "Q3"), "S", "L")
nosa_stel_rows$method2 <- paste0(nosa_stel_rows$methodNo, "",nosa_stel_rows$method2)

nosa_stel_rows$method3 <- ifelse(nosa_stel_rows$nth %in% c("Q1", "Q2"), "S", 
                                 ifelse(nosa_stel_rows$nth %in% c("Q3", "Q4"), "M", "L"
                                 ))
